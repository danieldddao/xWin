...
{
    public class XControllerImplementation
    {
        ...
        public XControllerImplementation(short deadZoneRad = 7000)
        {
        ...
        public XControllerImplementation(SharpDX.XInput.Controller contoller, short deadZoneRad = 7000)
        {
